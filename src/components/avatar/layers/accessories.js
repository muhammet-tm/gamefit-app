...
export const ACCESSORY_LAYERS = {
  halo: {
    ...
    paths: [
      { d: `M100,9 m-24,0 a24,9 0 1,0 48,0 a24,9 0 1,0 -48,0
        ...
        fill: 'var(--av-gold)', fillRule: 'evenodd' },
      { d: `M100,9 m-24,0 a24,9 0 1,0 48,0 a24,9 0 1,0 -48,0
            M100,9 m-21,0 a21,7.5 0 1,1 42,0 a21,7.5 0 1,1 -42,0`,
        fill: 'var(--av-gold-light)', fillRule: 'evenodd', opacity: 0.7 },
    ],
  },
  crown: {
    slot: 'head',
  ...
  lightning: {
    ...
    animated: 'flicker',
    paths: [
      { d: `M58,96 L70,96 L62,120 L74,120 L54,156 L60,128 L48,128 Z`, fill: 'var(--av-gold-light)', opacity: 0.85 },
      { d: `M142,96 L130,96 L138,120 L126,120 L146,156 L140,128 L152,128 Z`, fill: 'var(--av-gold-light)', opacity: 0.85 },
      { d: `M70,70 L78,70 L73,84 L81,84 L68,106 L72,90 L64,90 Z`, fill: 'var(--av-gold-light)', opacity: 0.6 },
      { d: `M130,70 L122,70 L127,84 L119,84 L132,106 L128,90 L136,90 Z`, fill: 'var(--av-gold-light)', opacity: 0.6 },
    ],
  },
  shield_glow: {
    slot: 'gear',
  ...
  sword_glow: {
    ...
    animated: 'pulse',
    paths: [
      { d: `M150,90 L156,96 L128,160 C126,164 120,162 121,158 Z`, fill: 'var(--av-gold-light)', opacity: 0.9 },
      { d: `M152,92 L156,96 L128,160 C127,162 125,163 123,162 Z`, fill: 'var(--av-gold)', opacity: 0.9 },
      { d: `M144,96 L160,104 L157,109 L141,101 Z`, fill: 'var(--av-steel-dark)' },
      { d: `M154,86 m-4,0 a4,4 0 1,0 8,0 a4,4 0 1,0 -8,0`, fill: 'var(--av-gold-light)', opacity: 0.6 },
    ],
  },
  wings: {
    slot: 'back',
