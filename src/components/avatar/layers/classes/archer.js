  ...
  gear: {
    1: [
      ...
      { slot: 'back', d: `M60,62 C38,96 32,152 46,212 C48,219 56,218 55,211 C44,156 48,104 66,68
          C69,62 63,56 60,62 Z`, fill: 'var(--av-wood-dark)' },
      { slot: 'back', d: `M63,60 C66,60 68,64 66,68 C55,90 50,116 50,142 L45,142 C46,112 52,82 63,60 Z`,
        fill: 'var(--av-wood-dark)' },
      // recurve tips
      { slot: 'back', d: `M58,56 C62,50 70,50 72,56 C68,56 63,58 60,62 Z`, fill: 'var(--av-wood-dark)' },
      { slot: 'back', d: `M44,214 C40,220 44,228 51,228 C48,224 46,219 47,214 Z`, fill: 'var(--av-wood-dark)' },
      // string
      { slot: 'back', d: `M62,60 L48,214 L50,215 L64,61 Z`, fill: 'var(--av-steel-light)', opacity: 0.85 },
    ...
    2: [
      ...
      { slot: 'back', d: `M135,44 L144,48 L134,96 L126,93 Z`, fill: 'var(--av-c2)' },
      // arrow shafts + fletchings rising past the head line
      { slot: 'back', d: `M128,42 L131,20 L134,42 Z`, fill: 'var(--av-wood)' },
      { slot: 'back', d: `M136,46 L142,26 L145,48 Z`, fill: 'var(--av-wood)' },
      { slot: 'back', d: `M127,22 L131,12 L136,24 L131,28 Z`, fill: 'var(--av-c1)' },
      { slot: 'back', d: `M138,28 L144,18 L148,30 L142,34 Z`, fill: 'var(--av-c1)' },
      // bracers
    ...
    5: [
      ...
      { slot: 'auraB', d: `M32,184 C56,176 84,178 106,190 C82,192 60,198 44,208 C32,212 26,192 32,184 Z`,
        fill: 'var(--av-glow)', opacity: 0.25, aura: true },
