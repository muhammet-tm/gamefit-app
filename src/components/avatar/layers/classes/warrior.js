...
export default {
  gear: {
    1: [
      ...
      // fuller line
      { slot: 'back', d: `M148,20 L151,23 L127,80 L124,78 Z`, fill: 'var(--av-steel-dark)', opacity: 0.8 },
      // crossguard
      { slot: 'back', d: `M112,82 L134,92 L131,99 L109,89 Z`, fill: 'var(--av-c2)' },
      // grip + pommel (disappears behind the shoulder)
      { slot: 'back', d: `M116,92 L124,96 L118,110 C116,114 110,112 112,107 Z`, fill: 'var(--av-wood-dark)' },
    ...
    2: [
      ...
      { slot: 'gear', d: `M49,92 C48,80 60,72 74,76 C81,78 84,84 83,90 C72,83 57,84 49,92 Z`,
        fill: 'var(--av-c2)' },
      { slot: 'gear', d: `M66,62 C74,64 82,70 85,78 L85,82 C79,77 72,73 66,72 Z`, fill: 'var(--av-c2)' },
      // rivets
      ...
      { slot: 'gear', d: `M97,130 L103,130 L103,138 L97,138 Z`, fill: 'var(--av-wood-dark)' },
    ],
    3: [
    ...
    4: [
      ...
      { slot: 'head', d: `M81,28 L119,28 L119,29.6 L81,29.6 Z`, fill: 'var(--av-gold)', opacity: 0.7 },
      ...
      { slot: 'head', d: `M115,20 C123,16 129,8 130,-0 C121,2 113,8 109,15 C107,18 111,22 115,20 Z`,
        fill: 'var(--av-steel)' },
      { slot: 'head', d: `M72,2 C78,4 84,9 88,14 L91,15 C87,8 80,3 72,2 Z`, fill: 'var(--av-steel)' },
    ],
    5: [
